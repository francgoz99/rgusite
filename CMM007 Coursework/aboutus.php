...
<h2 align="center" style="font-family:love; color:#000066">ABOUT OUR APP.....</h2>
<div style="font-size:14px">
<p><b style="font-family:fantasy; font-size:16px">Virtual Diary</b> is an app for anyone who wants to keep a personal online diary, and is designed to be fast and easy to use.<br />
...
&nbsp;&nbsp;<span class="glyphicon glyphicon-earphone" aria-hidden="true">&nbsp;francgoz</span>&nbsp;&nbsp;
<span class="glyphicon glyphicon-earphone" aria-hidden="true"> 07451235476</span>
</p>
</div><!--col-md-6 end-->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<h4 style="color:#202020">Francgoz Online Services</h4>
