...
<div class="row logo">
<div class="col-md-6">
<h1><span style="color:#FFCA82">My&nbsp;Virtual Diary</span>&nbsp;<span style="font-size:15px; color:#fff;">Soft copy of my thoughts...</span></h1>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="col-md-5">
		<h4 style="color:#202020">07895636044</h4>
		<h4>Francgoz Online Services</h4>
		</div>
		<div class="col-md-3">
