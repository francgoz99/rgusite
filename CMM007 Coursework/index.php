  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<div class="row">
		<div class="col-md-3">
		 <img src="" width=100 height=100 alt="Francgoz Online Services." class="img-rounded">
		 </div>
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-size:18px" title="Find on Facebook">Francgoz Online Services.</a>
